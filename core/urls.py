...
urlpatterns = [
   ...
   ##     path('evaluaciones/<int:id_evaluacion>/eliminar/', evaluaciones_view.eliminar_evaluacion, name='eliminar_evaluacion'),
        ...
        path('dashboard/api/capacitaciones/', api.api_capacitaciones, name='api_capacitaciones'),
        ...
        path('empleado/<int:empleado_id>/asignar-habilidad/', informes_view.asignar_habilidad_view, name='asignar_habilidad'),
        path('empleado/<int:empleado_id>/eliminar-habilidad/<int:habilidad_id>/', informes_view.eliminar_habilidad_empleado_view, name='eliminar_habilidad_empleado'),
        path('api/habilidades/crear-rapido/', informes_view.api_crear_habilidad_rapida, name='api_crear_habilidad_rapida'),
        ...
        path('dashboard/api/empleado/capacitaciones/', api.api_capacitaciones_empleado, name='api_capacitaciones_empleado'),
        ...
        path('capacitaciones/detalle/emp/', informes_view.capacitaciones_detalle_view_emp, name='capacitaciones_detalle_emp'),
        path('api/capacitaciones/detalle/emp/', informes_view.api_capacitaciones_detalle_emp, name='api_capacitaciones_detalle_emp'),
