...
--
-- Table structure for table `desempeno_criterio`
--
...
--
-- Dumping data for table `desempeno_criterio`
--

LOCK TABLES `desempeno_criterio` WRITE;
/*!40000 ALTER TABLE `desempeno_criterio` DISABLE KEYS */;
/*!40000 ALTER TABLE `desempeno_criterio` ENABLE KEYS */;
UNLOCK TABLES;
